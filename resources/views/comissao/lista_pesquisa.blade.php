        ...
        <section class="content">
            ...
            <div class="box">
                        ...
                        <div class="modal-content">
                            ...
                            <form  action="/updateApartamentoPreco" method="POST">
                                <div class="modal-body" style="background-color: darkseagreen">
                                    ...
                                    <button style="color: red; border-radius: 15px" class="btn-btn-success pull-left"><a href="/comissaoListar" >Sair</a></button>
                ...
                <div class="box-footer">
                    <button style="border-radius: 15px"><a href="comissaoListar" style="border-radius: 15px" class="btn-success">voltar</a></button>
                </div>
                <!-- /.box-footer-->
            </div>
            <!-- /.box -->
