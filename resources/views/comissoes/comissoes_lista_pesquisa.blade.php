        ...
        <section class="content">
            ...
            <div class="box">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <tr>
                                ...
                                <th class="text-center" style=" color: lightseagreen">Proprietario</th>
                                <th class="text-center" style=" color: lightseagreen">Contacto</th>
                ...
                <div class="box-footer">
                    <button style="border-radius: 15px"><a href="listar" style="border-radius: 15px" class="btn-success">voltar</a></button>
                </div>
                <!-- /.box-footer-->
            </div>
            <!-- /.box -->
