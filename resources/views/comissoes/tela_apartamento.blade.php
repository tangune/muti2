        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <!--h3 class="box-title" style="color: green"> Registar apartamentos</h3 -->
                    ...
                    <div class="">
                        <form  action="/gravarApartamento" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="panel-body" >
                                ...
                                <label style="color: green">Descrição</label>
                                ...
                                <input type="hidden"  name="users_id" value="{{auth()->id()}}" class="form-control" >
                                ...
                                <input type="file" style="border-radius: 15px" name="imagem" class="form-control" placeholder="imagem da casa"></br>
