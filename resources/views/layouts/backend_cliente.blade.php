      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/expediente"><i class="fa fa-circle-o"></i>Serviços</a></li>
            <!--li class="active"><a href="/expediente_confirmado"><i class="fa fa-circle-o"></i>Confirmada</a></li-->
          </ul>
      </ul><br><br><br>
