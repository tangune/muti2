...
<div class="wrapper"  >
    ...
    <header class="main-header"  >
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-lg" style="background-color: #2d8f6f;"><b >Agentes</b></span>
        </a>
        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-static-top" style="background-color: #2d8f6f;">
    ...
    <aside class="main-sidebar" style="background-color: #2d8f6f;">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree" >
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu" style="background-color: #2d8f6f;">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu" style="background-color: #2d8f6f;">
                        <li class="active"><a href="/listar"><i class="fa fa-circle-o"></i> Apartamentos</a></li>
                        <!--li class="active"><a href="/reservas_comissoes"><i class="fa fa-circle-o"></i> Espediente</a></li -->
                    </ul>
            </ul>
        </section>
        <!-- /.sidebar -->
