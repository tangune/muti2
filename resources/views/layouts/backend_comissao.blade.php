...
<head>
  ...
  <!-- adicionado por tangune -->
  <link rel="stylesheet" href="https://cdn.datatables.net/1.10.20/css/dataTables.bootstrap4.min.css" >
  <!-- fim adicionado por tangune -->
...
<div class="wrapper" >
  ...
  <header class="main-header" >
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg" style="background-color: green;"><b >Comi</b>ssão</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu" style="background-color: green;">
            <li class="active"><a href="/agente"><i class="fa fa-circle-o"></i> Agente</a></li>
            <li class="active"><a href="/proprietario"><i class="fa fa-circle-o"></i> Proprietário</a></li>
            <li class="active"><a href="/casa"><i class="fa fa-circle-o"></i> Casa </a></li>
            <li class="active"><a href="/apartamento"><i class="fa fa-circle-o"></i> Apartamento</a></li>
            <li class="active"><a href="/detalhe"><i class="fa fa-circle-o"></i> Detalhe</a></li>
          </ul>
        <li class="active treeview" >
          <a href="#">
          ...
          <ul class="treeview-menu" style="background-color: green;">
            ...
            <li class="active"><a href="/comissaoListar"><i class="fa fa-circle-o"></i> Apartamentos</a></li>
          </ul>
        <li class="active treeview" >
          <a href="#">
          ...
          <ul class="treeview-menu" style="background-color: green;">
            <li class="active"><a href="/reservas"><i class="fa fa-circle-o"></i> Reservas</a></li>
            <li class="active"><a href="/enviarEmail"><i class="fa fa-circle-o"></i> Email</a></li>
            <li class="active"><a href="/mensagem"><i class="fa fa-circle-o"></i> SMS</a></li>
          </ul>
      </ul>
    </section>
    <!-- /.sidebar -->
