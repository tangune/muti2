    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <form action="/pesquisaApartamento" method="GET">
                ...
                <select type="text" name="bairro" class="form-control" style="border-radius: 15px; width: 18%; height: 30px; padding-left: 10px; margin-left: 2%;  border-color: blue; float: left">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-footer">
                  <button style="border-radius: 15px"><a href="lista_apartamento" style="border-radius: 15px" class="btn-success">voltar</a></button>
                </div>
                <!-- /.box-footer-->
            </div>
            <!-- /.box -->
