        ...
        <section class="content">
            ...
            <div class="box">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <tr>
                                ...
                                <th class="text-center" style=" color: green">Data</th>
                            </tr>
                            <tbody>
                            @foreach($casas as $casa)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><img src="images/{{$casa->img }}" alt="..." width="150" height="50"></td>
                                    ...
                                    <!--button style="size: b5;font-weight: 100; background-color: lightblue" type="button" class="btn btn-primary btn-small"
                ...
                <div class="box-footer">
                    <button style="border-radius: 15px"><a href="lista_casa" style="border-radius: 15px" class="btn-success">voltar</a></button>
                </div>
                <!-- /.box-footer-->
            </div>
            <!-- /.box -->
