        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title" style="color: darkblue"> Lista de reservas</h3><br>
                    <section class="content-header">
                        <form action="/admin_pesquisar_reservas" method="GET">
                            {{ csrf_field() }}
                            <button style="border-radius: 15px; color: blue; float: right; margin-right: 35%"  name="pesquisar">Pesquisar</button>
